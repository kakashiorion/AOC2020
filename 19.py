...
messages=['bbabbbaaaaaabbabbaabaaabbaababbbabbbabbbababbbbbbbbabbbbbbabaaaa',
...
while (len(considered)!=len(rules)):
    for item in d:
        for r in considered:
            for y in range(len(d[item])):
                if d[item][y]==r:
                    d[item][y]=e[r]
                    # print(d[item],r)
        l=0
        for t in d[item]:
            if isinstance(t,list)==True or t =='|':
                l+=1
        if l==len(d[item]) and item not in considered:
            p=[]
            if l==1:
                for i0 in d[item][0]:
                    p.append(i0)
                    ...
                    #     p.append(i0+i0)
                    #     p.append(i0+i0+i0)
                    #     p.append(i0+i0+i0+i0)
                    #     p.append(i0+i0+i0+i0+i0)
                    #     p.append(i0+i0+i0+i0+i0+i0)
                    #     p.append(i0+i0+i0+i0+i0+i0+i0)
                    #     p.append(i0+i0+i0+i0+i0+i0+i0+i0)
                    #     p.append(i0+i0+i0+i0+i0+i0+i0+i0+i0)
            elif l==2:
                for i0 in d[item][0]:
                    for i1 in d[item][1]:
                        # if item=='0':
                        ...
                        p.append(i0+i1)
                        # if item=='11':
                        #     p.append(i0+i0+i1+i1)
                        #     p.append(i0+i0+i0+i1+i1+i1)
                        #     p.append(i0+i0+i0+i0+i1+i1+i1+i1)
                        #     p.append(i0+i0+i0+i0+i0+i1+i1+i1+i1+i1)
...
print("length 42:", len(e['42']))
print("length 31:", len(e['31']))
print("length 8:", len(e['8']))
print("length 11:", len(e['11']))

l=0
for item in e['8']:
    l+=len(item)
print("avg 8", l/len(e['8']))
...
for m in messages:
    ...
    if len(m)==24:
        if m[0:8] in e['8'] and m[8:24] in e['11']:
            count+=1
    elif len(m)==32:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:32] in e['11']:
            count+=1
    elif len(m)==40:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:40] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['42'] and m[16:32] in e['11'] and m[32:40] in e['31']:
            count+=1
    elif len(m)==48:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:48] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['42'] and m[24:40] in e['11'] and m[40:48] in e['31']:
            count+=1
    elif len(m)==56:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:56] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['42'] and m[32:48] in e['11'] and m[48:56] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['42'] and m[16:24] in e['42'] and m[24:40] in e['11'] and m[40:48] in e['31'] and m[48:56] in e['31']:
            count+=1
    elif len(m)==64:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['8'] and m[48:64] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['42'] and m[40:56] in e['11'] and m[56:64] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['42'] and m[24:32] in e['42'] and m[32:48] in e['11'] and m[48:56] in e['31'] and m[56:64] in e['31']:
            count+=1
    elif len(m)==72:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['8'] and m[48:56] in e['8'] and m[56:72] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['42'] and m[48:64] in e['11'] and m[64:72] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['42'] and m[32:40] in e['42'] and m[40:56] in e['11'] and m[56:64] in e['31'] and m[64:72] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['42'] and m[16:24] in e['42'] and m[24:32] in e['42'] and m[32:48] in e['11'] and m[48:56] in e['31'] and m[56:64] in e['31'] and m[64:72] in e['31']:
            count+=1
    elif len(m)==80:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['8'] and m[48:56] in e['8'] and m[56:64] in e['8'] and m[64:80] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['8'] and m[48:56] in e['42'] and m[56:72] in e['11'] and m[72:80] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['42'] and m[40:48] in e['42'] and m[48:64] in e['11'] and m[64:72] in e['31'] and m[72:80] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['42'] and m[24:32] in e['42'] and m[32:40] in e['42'] and m[40:56] in e['11'] and m[56:64] in e['31'] and m[64:72] in e['31'] and m[72:80] in e['31']:
            count+=1
    elif len(m)==88:
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['8'] and m[48:56] in e['8'] and m[56:64] in e['8'] and m[64:72] in e['8'] and m[72:88] in e['11']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['8'] and m[48:56] in e['8'] and m[56:72] in e['42'] and m[64:80] in e['11'] and m[80:88] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['8'] and m[32:40] in e['8'] and m[40:48] in e['42'] and m[48:56] in e['42'] and m[56:72] in e['11'] and m[72:80] in e['31'] and m[80:88] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['8'] and m[16:24] in e['8'] and m[24:32] in e['42'] and m[32:40] in e['42'] and m[40:48] in e['42'] and m[48:64] in e['11'] and m[64:72] in e['31'] and m[72:80] in e['31'] and m[80:88] in e['31']:
            count+=1
        if m[0:8] in e['8'] and m[8:16] in e['42'] and m[16:24] in e['42'] and m[24:32] in e['42'] and m[32:40] in e['42'] and m[40:56] in e['11'] and m[56:64] in e['31'] and m[64:72] in e['31'] and m[72:80] in e['31'] and m[80:88] in e['31']:
            count+=1
print(count)
# #part2:274
